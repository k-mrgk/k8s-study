...
import (
	...
	versioned "github.com/k-mrgk/k8s-study/crd-sample/pkg/client/clientset/versioned"
	internalinterfaces "github.com/k-mrgk/k8s-study/crd-sample/pkg/client/informers/externalversions/internalinterfaces"
	v1beta "github.com/k-mrgk/k8s-study/crd-sample/pkg/client/listers/workflow/v1beta"
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workflowv1beta.Workflow{}, f.defaultInformer)
}
